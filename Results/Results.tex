...
\label{sec:results}
    ...
    However, based on the behaviors we observed in our simulations we would expect a hardware implementation of LoopAware to successfully split traffic between links, mitigating the effects of link congestion.
